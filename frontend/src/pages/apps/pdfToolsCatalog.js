export const PDF_TOOLS = [
  { slug: 'merge-pdf', title: 'Fusionner PDF', description: 'Fusionner et combiner des fichiers PDF et les mettre dans l\'ordre que vous voulez. C\'est très facile et rapide!', color: 'text-danger', icon: 'feather-git-merge', action: 'Fusionner les PDF', accept: '.pdf', multiple: true, category: 'manipulation' },
  ...
  { slug: 'organize-pdf', title: 'Organiser PDF', description: 'Réorganiser, supprimer ou extraire des pages de vos PDF', color: 'text-danger', icon: 'feather-layers', action: 'Organiser le PDF', accept: '.pdf', multiple: false, category: 'manipulation', isGrouped: true },
